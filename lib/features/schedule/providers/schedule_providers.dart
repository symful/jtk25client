...
// ---------------------------------------------------------------------------
// Pengganti mode — show pengganti list instead of day schedule
// ---------------------------------------------------------------------------

/// Whether the schedule view is showing pengganti entries.
class _PenggantiModeNotifier extends Notifier<bool> {
  @override
  bool build() => false;

  void toggle() => state = !state;
  void showPengganti() => state = true;
  void showSchedule() => state = false;
}

/// When true, the schedule page shows pengganti entries instead of day schedule.
final showingPenggantiProvider = NotifierProvider<_PenggantiModeNotifier, bool>(
  _PenggantiModeNotifier.new,
);
